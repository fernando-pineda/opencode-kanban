...
import { listBoards, getBoardFull, getOrCreateBoard, archiveBoard, moveSessionToColumn, searchCards, getSubtasks, createSubtask, updateSubtask, deleteSubtask, addAgentLog, getAgentLogs, getDistinctRepos, markSessionCompleted, unmarkSessionCompleted, getSessionMessages, getEnabledRulesContent, listRules, createRule, updateRule, deleteRule, getDb, getAllSettings, setSetting, getAutoCompactThreshold, isAutoCompactEnabled, getSessionTokens, getSessionModel, getActiveSessionIds, } from "./db.js";
// ── Setup ────────────────────────────────────────────────────
...
app.post("/api/sessions/:sessionId/respond", async (req, res) => {
    try {
        ...
        if (sessionDir)
            respondUrl.searchParams.set("directory", sessionDir);
